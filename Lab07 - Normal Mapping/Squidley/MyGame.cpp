...
GLuint passThroughProgramID, pTShaderProgramID, pCshaderProgramID, pCTShaderProgramID, 
		...
		depthShaderProgramID, pTNShaderProgramID, normalMappingShaderProgramID;
...
void MyGame::SendDataToOpenGL()
{
	...
	Geometry* scene = ShapeGenerator::makeScene("..\\..\\Static_Data\\Scenes\\AIWorld.ptntb.scene");

	Geometry* clone = ShapeGenerator::makeScene("..\\..\\Static_Data\\Scenes\\Jaina.pt.scene");
	...
	render[0].m_vertexShaderInfo.programID = normalMappingShaderProgramID;
	render[0].m_vertexShaderInfo.callback = uniformCallbackNormalMapping;
	texture = render[0].getTextureInfo();
	texture.loadBMP_custom("..\\Data\\Textures\\brickwall.bmp");
	texture.loadNormalMap("..\\Data\\Textures\\brickwall_normal.bmp");
