...
{
public:
	void writeCustomBinaryFile(const char* filename, short vertForm, int numVerts, int numIndices, glm::vec3* verts, glm::vec3* color, glm::vec2* texture, glm::vec3* normals, glm::vec3* tangents, glm::vec3* bitangents, GLuint* indices);
	...
	int writeVertexData(std::ofstream& out, short vertForm, int numVerts, glm::vec3* verts, glm::vec3* color, glm::vec2* texture, glm::vec3* normals, glm::vec3* tangents, glm::vec3* bitangets);
