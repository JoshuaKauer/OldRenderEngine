...
int main()
{
	...
	writer.writeCustomBinaryFile(ConfigReader::findValueForKey("AIWorldOutput"), parse.vertexFormat, parse.indCount, parse.indCount, parse.finalVerts, parse.finalColors, parse.finalTextures, parse.finalNormals, parse.finalIndices);
	Logger::shutDown();
}