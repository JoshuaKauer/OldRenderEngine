...
int main()
{
	...
	parse.readTextFile(ConfigReader::findValueForKey("AIWorldInput"));
	writer.writeCustomBinaryFile(ConfigReader::findValueForKey("AIWorldOutput"), parse.vertexFormat, parse.indCount, parse.indCount, parse.finalVerts, parse.finalColors, parse.finalTextures, parse.finalNormals, parse.finalTans, parse.finalBiTans, parse.finalIndices);
	Logger::shutDown();
}