...
int main()
{
	...
	parse.readTextFile(ConfigReader::findValueForKey("WaterInput"));
	writer.writeCustomBinaryFile(ConfigReader::findValueForKey("WaterOutput"), parse.vertexFormat, parse.indCount, parse.indCount, parse.finalVerts, parse.finalColors, parse.finalTextures, parse.finalNormals, parse.finalIndices);
	Logger::shutDown();
}